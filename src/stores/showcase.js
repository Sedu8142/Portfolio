    ...
    projects: [
      {
        ...
        image: new URL('../assets/PAhome.png', import.meta.url).href,
        imageLibrary: [
          new URL('../assets/PAlogin.png', import.meta.url).href,
          new URL('../assets/PAhome.png', import.meta.url).href,
          new URL('../assets/PAsched.png', import.meta.url).href,
          new URL('../assets/PAhistory.png', import.meta.url).href,
        ],
      ...
      },
      {
        ...
        imageLibrary: [
          new URL('../assets/Breasy.png', import.meta.url).href
        ],
        alt: 'Breasy Image',
        status: 'done'
      },
      {
        ...
        imageLibrary: [
          new URL('../assets/TipsAndEats.png', import.meta.url).href
        ],
      ...
      },
      {
        ...
        imageLibrary: [
          new URL('../assets/financeTracker.png', import.meta.url).href
        ],
